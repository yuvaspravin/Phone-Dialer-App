...
const addFavorites = (item) => {
    console.log(item, "Adding to favorites");

    // Find and update the favorites property
    const updatedContactDetail = contactDetail.map(e =>
    ...
    console.log(updatedContactDetail, "Updated Contacts");
